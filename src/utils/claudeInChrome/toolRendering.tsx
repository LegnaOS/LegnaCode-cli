...
/**
 * Renders a clickable "View Tab" link for LegnaCode in Chrome MCP tools.
 * Returns null if:
 * - The tool is not a LegnaCode in Chrome MCP tool
...
/**
 * Returns tool method overrides for LegnaCode in Chrome MCP tools. Use this to customize
...
export function getClaudeInChromeMCPToolOverrides(toolName: string): {
  ...
  return {
    userFacingName(_input?: Record<string, unknown>) {
      ...
      return `LegnaCode in Chrome[${displayName}]`;
    },
