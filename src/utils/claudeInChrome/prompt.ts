export const BASE_CHROME_PROMPT = `# LegnaCode in Chrome browser automation
...
/**
 * Minimal hint about LegnaCode in Chrome skill availability. This is injected at startup when the extension is installed
