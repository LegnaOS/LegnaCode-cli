...
const DEFAULT_PREFIX = `You are LegnaCode, legna.lnc's official CLI for coding assistance.`
const AGENT_SDK_CLAUDE_CODE_PRESET_PREFIX = `You are LegnaCode, legna.lnc's official CLI for coding assistance, running within the Agent SDK.`
const AGENT_SDK_PREFIX = `You are a LegnaCode agent, built on legna.lnc's Agent SDK.`
