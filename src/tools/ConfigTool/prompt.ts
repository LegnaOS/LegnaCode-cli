...
export const DESCRIPTION = 'Get or set LegnaCode configuration settings.'
...
export function generatePrompt(): string {
  ...
  return `Get or set LegnaCode configuration settings.

  View or change LegnaCode settings. Use when the user requests configuration changes, asks about current settings, or when adjusting a setting would benefit them.
