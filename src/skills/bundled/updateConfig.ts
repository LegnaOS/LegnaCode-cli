...
Hooks run commands at specific points in LegnaCode's lifecycle.
...
| Stop | - | Run when LegnaCode stops (including clear, resume, compact) |
...
Modify LegnaCode configuration by updating settings.json files.
...
User: "Format my code after LegnaCode writes it"
...
6. **Use --debug** - Run \`legna --debug\` to see hook execution logs
`
